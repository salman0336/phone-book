...
import $css_0 from '@vaadin/flow-frontend/styles/vcf-crud-grid-edit.css';
addCssBlock(`<dom-module id="flow_css_mod_0" theme-for="vcf-crud-edit"><template><style>${$css_0}</style></template></dom-module>`);
import $css_1 from '@vaadin/flow-frontend/styles/vcf-crud.css';
addCssBlock(`<dom-module id="flow_css_mod_1" theme-for="vcf-crud"><template><style>${$css_1}</style></template></dom-module>`);
import $css_2 from '@vaadin/flow-frontend/styles/vcf-dialog-layout.css';
addCssBlock(`<dom-module id="flow_css_mod_2" theme-for="vcf-dialog-layout"><template><style>${$css_2}</style></template></dom-module>`);
import $css_3 from '@vaadin/flow-frontend/styles/dialog-overlay.css';
addCssBlock(`<dom-module id="flow_css_mod_3" theme-for="vaadin-dialog-overlay"><template><style>${$css_3}</style></template></dom-module>`);
...
import '@vaadin/flow-frontend/src/vcf-crud-edit-column.js';
import '@vaadin/flow-frontend/src/vcf-crud.js';
